...
@section('content')
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_link" class="form-control" value="{{ ($site->productLinks) ?  $site->productLinks->next_page  : ''}}">
                        </div>
                    </div>
 ...
 <div>
        @if(!empty($productLinks))
           <textarea style="width:100%; height:500px">{!! $productLinks->implode("\n") !!}</textarea>
